...
const AlphabetizeSort = ({ handleSortOption, sortOption }) => {
  return (
    <div className="bg-gray-800 p-4 rounded-lg border-solid border-2 border-gray-600 flex gap-2">
      <div className="flex gap-0 h-full">
        ...
        <div className="text-white grid w-4 place-items-center select-none">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            className="fill-white w-4 scale-75"
          >
        ...
        <div className="text-white grid w-4 place-items-center select-none">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
            className="fill-white w-4 scale-[90%]"
          >
...
const UpArrow = ({ handler, selected }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
      className={
        selected
          ...
          : "fill-gray-500 hover:fill-gray-400 cursor-pointer"
      }
      onClick={handler}
    >
...
const DownArrow = ({ handler, selected }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
