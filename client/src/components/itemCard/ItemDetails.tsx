...
interface ItemDetailsProps {
  ...
  handleAlt: (e: React.ChangeEvent<HTMLInputElement>) => void;
  handleStock: (e: React.ChangeEvent<HTMLInputElement>) => void;
  handlePrice: (e: React.ChangeEvent<HTMLInputElement>) => void;
  handleCategory: (e: React.ChangeEvent<HTMLInputElement>) => void;
  handleDiscontinuedFalse: () => void;
  handleDiscontinuedTrue: () => void;
  handleSrc: (e: React.ChangeEvent<HTMLTextAreaElement>) => void;
  newItem?: boolean;
}
