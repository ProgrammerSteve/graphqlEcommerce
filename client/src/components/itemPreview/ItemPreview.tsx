...
const ItemPreview: React.FC<ItemPreviewProps> = ({ item, handleNavigate }) => {
...
const HeaderDisplay: React.FC<HeaderDisplayProps> = ({ value }) => {
  return (
...
const TextDisplay: React.FC<TextDisplayProps> = ({ value, title }) => {
  return (
...
const TextAreaDisplay: React.FC<TextAreaDisplayProps> = ({ value, title }) => {
  return (
